...
const data =[
  ...
  return (
   ...
   >
<a href="https://github.com/Kenny001-spec" target='_blank' rel="noopener noreferrer" data-aos="zoom-in-down">
  <Logo/>
</a>
...
<div className={`${styles.navR} ${toggle && styles.active}`}>
  ...
  <a href="https://drive.google.com/file/d/1aNvDRa2Wjm0NWd0I37-iVYY7KIeNwp_v/view?usp=sharing" target='_blank' rel="noopener noreferrer">
